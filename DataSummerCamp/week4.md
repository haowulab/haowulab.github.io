...
6. Based on the `mtcars` data frame, 
	...
	<img src="mtcars-scatter-2panel.png" style="width:400px;"/>
	...
	<img src="mtcars-scatter-2panel-color.png" style="width:400px;"/>
	
	- Generate a figure with 4 panels in a 2x2 layout. I expect to see a figure like the following: 

	<img src="mtcars-scatter-4panel.png" style="width:400px;"/>
...
modify the parameters in the `matplot` function. 
	...
	<img src="power-curve.png" style="width:300px;"/>
